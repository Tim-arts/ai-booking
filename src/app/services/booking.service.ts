  ...
  private readonly mockBookings: Booking[] = [
    {
      ...
      description: 'Wake up to breathtaking ocean views in this elegant suite featuring modern amenities and world-class service.',
      price: 299,
    ...
    },
    {
      ...
      description: 'Stylish apartment in the heart of the city with easy access to attractions, dining, and entertainment.',
      price: 149,
    ...
    },
    {
      ...
      description: 'Escape to nature in this charming cabin surrounded by pristine mountains and forest trails.',
      price: 179,
